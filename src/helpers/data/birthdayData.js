...
const patchBirthday = (birthdayId, updatedBirthdayDate, updatedBirthdayImage) => axios.patch(`${baseUrl}/birthdays/${birthdayId}.json`, { date: updatedBirthdayDate, image: updatedBirthdayImage });
